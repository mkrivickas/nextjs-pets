...
export default function PetsListSection(props) {
  const [petInQuestion, setPetInQuestion] = useState({
    name: "Placeholder",
    species: "placeholder",
    photo: "",
    _id: "abc123",
    ...
    <>
      <div className="page-section" id="view-pets">
        <div className="page-section-inner">
          <h2 className="page-section-title">Tikrinis Žvėrelių Kalendorius</h2>
          <div className="pet-filter">
            <p>
              ...
              <button
                onClick={() => setCurrentFilter("dog")}
                className={currentFilter == "dog" ? "active" : ""}
              >
                Darbai
              </button>{" "}
              <button
              ...
              .map((pet) => {
                function petPhoto(photo) {
                  if (pet.photo) {
                    return (
                      <img
                        src={`https://res.cloudinary.com/${process.env.NEXT_PUBLIC_CLOUDNAME}/image/upload/w_660,h_784,c_fill/${pet.photo}.jpg`}
                    ...
                    <div className="pet-card-text">
                      <h3>
                        ...
                        <button
                          ...
                          className="pet-contact-btn"
                          aria-label="Adopt Barksalot"
                          data-id={pet._id.toString()}
                        >
                          <svg
                            aria-hidden="true"
                            focusable="false"
      ...
      <div
        ...
        className={
          isOverlayOpen
            ? "form-overlay form-overlay--is-visible"
            : "form-overlay"
        }
      >
        <form onSubmit={contactSubmit} className="form-overlay-inner" action="">
          <div className="form-content">
            ...
            <input
              ...
              className="form-field"
              type="text"
              aria-label="What is the word for this animal?"
              placeholder="Kaip pavadinsime šį žvėrį?"
            />
            <textarea
              name="comment"
              className="form-field"
            ...
            <div className="justify-right">
              <button className="our-btn">Patvirtinti</button>
            </div>
          ...
          <div className="form-photo">
            <img
              className="overlay-pet-photo"
              src={
                petInQuestion.photo
                  ? `https://res.cloudinary.com/${process.env.NEXT_PUBLIC_CLOUDNAME}/image/upload/w_660,h_784,c_fill/${petInQuestion.photo}.jpg`
                  : "/images/fallback.jpg"
              }
              alt={`A ${petInQuestion.species} named ${petInQuestion.name}`}
            />
            <p>
              Ačiū, kad domiesi{" "}
              <strong className="overlay-pet-name">
                {petInQuestion.name}.
              </strong>
            </p>
          </div>
          <div
            className={
              formWasJustSent ? "thank-you thank-you--visible" : "thank-you"
            }
          >
            <p>
              <svg
