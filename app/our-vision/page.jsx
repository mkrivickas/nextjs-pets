    ...
    <div className="page-section">
      <div className="page-section-inner">
        ...
        <div className="generic-page-content">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore explicabo, labore amet earum eum obcaecati pariatur. Maiores, quidem consequatur dolorem natus culpa modi. Dolorum laboriosam doloremque commodi, sunt officiis blanditiis. Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus sunt velit atque sit officiis, sequi rerum ipsam non commodi praesentium nisi minima voluptate cupiditate? Mollitia nobis accusamus.</p>
        </div>
      </div>
    </div>
  )
