  ...
  return (
    <div className="page-section">
      <div className="page-section-inner">
        ...
        <h2 className="page-section-title">Istorija</h2>
        <div className="generic-page-content">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In aperiam deleniti iusto dolore similique cum quos vitae est repellendus architecto quod culpa fugiat ad, hic distinctio quisquam assumenda reiciendis laborum.</p>
        </div>
      </div>
    </div>
  )
